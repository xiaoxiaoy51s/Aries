...
export class TerminalManager {
    ...
    /** 创建终端会话 */
    createSession(workDir, sessionId) {
    ...
    async execute(command, options = {}) {
        ...
        const outputBuffer = [];
        const captureCb = (data) => outputBuffer.push(data);
