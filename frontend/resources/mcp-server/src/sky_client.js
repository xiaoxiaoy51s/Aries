...
// Released layout: ~/.Aries/plugins/mcps/computer-use/{src/sky_client.js, codex-computer-use.exe}
// So from src/ it's ../codex-computer-use.exe
const DEFAULT_EXE =
  process.env.COMPUTER_USE_EXE ||
