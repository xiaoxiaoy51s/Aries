...
- `kun/src/domain/model-history-repair.ts`- `kun/src/services/thread-service.ts`
...
- `kun/src/loop/agent-loop.ts`
- `kun/src/loop/context-compactor.ts`
...
- `kun/src/services/usage-service.ts`
